    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      <header className="sticky top-0 z-40 flex items-center justify-between px-6 py-4 border-b border-white/5 bg-[#0a0a0f]/80 backdrop-blur-md">
        <div className="flex items-center gap-6">
          <Link href="/customer/products" className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {items.length > 0 && (
              <span className="absolute -top-1.5 -right-1.5 w-4 h-4 text-[10px] font-bold text-white bg-indigo-600 rounded-full flex items-center justify-center">
                {items.length}
              </span>
            )}
          </button>
